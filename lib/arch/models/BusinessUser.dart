...
class BUser{
  ...
  String _id, _bName, _bType, _state, _city, _email, _phoneNumber;

  BUser(this._bName, this._bType, this._state, this._city, this._email, this._phoneNumber);

  BUser.withID(this._id, this._bName, this._bType, this._state, this._city, this._email, this._phoneNumber);
